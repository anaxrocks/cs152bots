...
from train import FOUNDATION_MODEL, DATASET, MODELS_DIR, iterate_over_dataloader
import torch
...
def main(args):
    ...
    with torch.no_grad():
        ...
        test_loss = iterate_over_dataloader(model, tokenizer, None, test_dataset, False)
